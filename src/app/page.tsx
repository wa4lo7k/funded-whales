    ...
    <>
      ...
      <section id="how-it-works" className="py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 gradient-text-deep-blue-aqua fade-in-up-v3">
            How It Works
          </h2>
          <div className="max-w-3xl mx-auto">
            <div className="space-y-8">
              <div className="glass-card-modern-v3 p-6 fade-in-up-v3 animate-delay-100">
                <h3 className="text-xl font-semibold mb-4">1. Choose Your Challenge</h3>
              ...
              <div className="glass-card-modern-v3 p-6 fade-in-up-v3 animate-delay-200">
                <h3 className="text-xl font-semibold mb-4">2. Pass the Challenge</h3>
                <p className="text-muted-foreground">
              ...
              <div className="glass-card-modern-v3 p-6 fade-in-up-v3 animate-delay-300">
                <h3 className="text-xl font-semibold mb-4">3. Get Funded</h3>
                <p className="text-muted-foreground">
              ...
              <div className="glass-card-modern-v3 p-6 fade-in-up-v3 animate-delay-400">
                <h3 className="text-xl font-semibold mb-4">4. Scale Your Account</h3>
                <p className="text-muted-foreground">
      ...
      <section id="pricing" className="py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 gradient-text-violet-pink fade-in-up-v2">
            Pricing
          </h2>
