...
export function NewFooter() {
  return (
    <footer className="footer-design-upgrade dark-gradient">
      {/* Dark theme is now the only option */}

      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Brand Section */}
          <div className="col-span-1">
            <h2 className="text-xl font-bold mb-4">Funded Horizon</h2>
            <p className="footer-text mb-6">
              Professional trading challenges and funded accounts for serious traders.
              Access institutional-grade tools and support to elevate your trading career.
            </p>
            <div className="social-icons">
              ...
              <a href="https://t.me/fundedhorizon" target="_blank" rel="noopener noreferrer" aria-label="Telegram" className="social-icon">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a href="https://discord.com" target="_blank" rel="noopener noreferrer" aria-label="Gaming" className="social-icon">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="col-span-1">
            ...
            <ul>
              <li>
                <Link href="#trading-challenges" className="footer-link">
                  Trading Challenges
                </Link>
              </li>
          ...
          <div className="col-span-1">
            ...
            <div className="mb-4">
              <p className="flex items-center footer-text mb-2">
                ...
                <a href="mailto:support@fundedhorizon.com" className="hover:text-blue-500 transition-colors">
        ...
        <div className="risk-disclosure">
          <div className="mb-6">
            ...
            <p className="risk-text">
              ...
              Funded Horizon does not execute trades or manage funds. Services are provided through third parties.
